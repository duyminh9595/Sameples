...
print Green "========== Generating Anchor Peer Update For thaysonMSP =========="
echo ""

/home/ubuntu/fabric-samples/bin/configtxgen  -profile FourOrgsChannel -configPath ./configtx/ -outputAnchorPeersUpdate ./channel-artifacts/thaysonMSPAnchor.tx -channelID $CHANNEL_NAME -asOrg thaysonMSP

print Green "========== Anchor Peer Update For thaysonMSP Sucessful =========="
echo ""

print Green "========== Generating Anchor Peer Update For cohuongMSP =========="
echo ""

../../fabric-samples/bin/configtxgen -profile FourOrgsChannel -configPath ./configtx/ -outputAnchorPeersUpdate ./channel-artifacts/cohuongMSPAnchor.tx -channelID $CHANNEL_NAME -asOrg cohuongMSP

print Green "========== Anchor Peer Update For cohuongMSP Sucessful =========="
echo ""
